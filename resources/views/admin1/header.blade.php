...
<!-- Mirrored from demo.tailadmin.com/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 21 Aug 2023 09:50:24 GMT -->
...
<head>
  ...
  <link href="{{ asset('admin1')}}/style.css" rel="stylesheet"></head>
              ...
              <ul class="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                <li>
                  <a class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white"
                    href="index.html" :class="page === 'ecommerce' && '!text-white'">Tambah Pesanan
                    </a>
                </li>
                <li>
                  <a
